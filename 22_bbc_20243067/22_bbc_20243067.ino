...
#define _DUTY_MAX 1980 // 2000
#define _DUTY_NEU 1670 // 1500
#define _DUTY_MIN 1180 // 1000

#define _SERVO_ANGLE_DIFF  44  // Replace with |D - E| degree
#define _SERVO_SPEED       80  // servo speed

#define _BANGBANG_RANGE    1200  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  // return 447 + (-1.39)* a_value + 1.01E-03 * a_value * a_value;
    return 651 + -3.53*a_value + 7.12E-03*a_value*a_value + -4.96E-06*a_value*a_value*a_value;
}
